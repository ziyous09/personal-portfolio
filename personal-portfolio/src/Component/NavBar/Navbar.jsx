    ...
    >
      ...
      <header className="fixed top-[40px] w-full max-w-7xl mx-auto z-50 px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
            ...
            {/* Get Resume Button */}
            <button
                className={`hidden sm:flex items-center justify-center gap-2 font-medium transition-colors duration-300 h-11 px-5 rounded-full backdrop-blur-xl shadow-lg ${
                  theme === 'dark'
...
// Navbar Component
const Navbar = ({ theme }) => {
  const navLinks = ['Home', 'About', 'Work', 'Contact Us', 'Blog'];

  return (
    <div
      className={`relative px-10 sm:px-16 py-5 rounded-full ${
        theme === 'dark'
